...
# Dify API settings
DIFY_API_KEY_DISCUSSION_CONTENT = env.str("DIFY_API_KEY_DISCUSSION_CONTENT")
DIFY_API_KEY_GENR_AI_REP = env.str("DIFY_API_KEY_GENR_AI_REP")
DIFY_API_KEY_PROV_JUDGMENT = env.str("DIFY_API_KEY_PROV_JUDGMENT")
